            ...
            <form className="p-6 space-y-4 text-right" dir="rtl" onSubmit={handleSaveExpense}>
              ...
              <div className="space-y-1.5 p-3 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <select 
                  ...
                  className={`w-full border border-slate-200 rounded-xl px-4 py-2 text-sm outline-none transition-all ${
                    isVehicleLinked ? "bg-white border-red-200 focus:ring-2 focus:ring-red-500" : "bg-slate-100 text-slate-400 cursor-not-allowed"
                  }`}
                >
