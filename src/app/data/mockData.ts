...
export interface Van {
  id: string;
  driverName: string; // السائق (بدون حساب)
  representativeId?: string; // المندوب המربوط
...
export const vans: Van[] = [
  ...
  {
    id: "VAN-003",
    driverName: "ياسر عبدالرحمن طارق",
  ...
  {
    id: "VAN-004",
    driverName: "حسين جابر محمد",
    representativeId: "USR-006",
    representativeName: "عمر حسن الشاذلي",
  ...
  {
    id: "VAN-005",
    driverName: "محمود عبدالعزيز السيد",
    representativeId: "USR-007",
    representativeName: "سعد عبدالله الشربيني",
  ...
  {
    id: "VAN-006",
    driverName: "عادل حسام الدين",
    representativeId: "USR-008",
    representativeName: "فيصل محمد الجمال",
...
export const users: User[] = [
  ...
  { id: "USR-003", name: "أحمد محمد السعيد", email: "van1@bareeq.eg", role: "مندوب", status: "نشط", joinDate: "2024-03-10", phone: "0501234567", assignedVanId: "VAN-001" },
  { id: "USR-004", name: "محمد علي البحيري", email: "van2@bareeq.eg", role: "مندوب", status: "نشط", joinDate: "2024-03-10", phone: "0509876543", assignedVanId: "VAN-002" },
  { id: "USR-005", name: "خالد إبراهيم سلامة", email: "van3@bareeq.eg", role: "مندوب", status: "نشط", joinDate: "2024-04-05", phone: "0555554444", assignedVanId: "VAN-003" },
  { id: "USR-006", name: "عمر حسن الشاذلي", email: "van4@bareeq.eg", role: "مندوب", status: "غير نشط", joinDate: "2024-04-05", phone: "0555555555", assignedVanId: "VAN-004" },
  { id: "USR-007", name: "سعد عبدالله الشربيني", email: "van5@bareeq.eg", role: "مندوب", status: "غير نشط", joinDate: "2024-05-20", phone: "0556666666", assignedVanId: "VAN-005" },
  { id: "USR-008", name: "فيصل محمد الجمال", email: "van6@bareeq.eg", role: "مندوب", status: "نشط", joinDate: "2024-06-01", phone: "0557777777", assignedVanId: "VAN-006" },
